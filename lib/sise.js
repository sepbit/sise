...
function run () {
  ...
  if (document.getElementById('siseDiaspora')) {
    document.getElementById('siseDiaspora').addEventListener('click', sise.shareDiaspora())
  }

  if (document.getElementById('siseFriendica')) {
    document.getElementById('siseFriendica').addEventListener('click', sise.shareDiaspora())
  }

  if (document.getElementById('siseGnusocial')) {
    document.getElementById('siseGnusocial').addEventListener('click', sise.shareGnuSocial())
  }

  if (document.getElementById('siseHubzilla')) {
    document.getElementById('siseHubzilla').addEventListener('click', sise.shareHubzilla())
  }

  if (document.getElementById('siseMastodon')) {
    document.getElementById('siseMastodon').addEventListener('click', sise.shareMastodon())
  }

  if (document.getElementById('siseSocialhome')) {
    document.getElementById('siseSocialhome').addEventListener('click', sise.shareDiaspora())
  }
} run()
