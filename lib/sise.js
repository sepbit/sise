...
const sise = {
  ...
  view: function () {
    return '<p>https:// <input type="text" placeholder="mastodon.social" ' +
      ...
      '<p>' +
        '<img style="cursor: pointer;" src="' + this.image + '/diaspora.png"' +
          'alt="diaspora*" title="diaspora*" height="45" id="siseDiaspora" /> ' +
        '<img style="cursor: pointer;" src="' + this.image + '/friendica.png" ' +
          'alt="Friendica" title="Friendica" height="45" id="siseFriendica" /> ' +
        '<img style="cursor: pointer;" src="' + this.image + '/gnusocial.png" ' +
          'alt="GNU Social" title="GNU Social" height="45" id="siseGnusocial" /> ' +
        '<img style="cursor: pointer;" src="' + this.image + '/hubzilla.png"' +
          'alt="Hubzilla" title="Hubzilla" height="45" id="siseHubzilla" /> ' +
        '<img style="cursor: pointer;" src="' + this.image + '/mastodon.png" ' +
          'alt="Mastodon" title="Mastodon" height="45" id="siseMastodon" /> ' +
        '<img style="cursor: pointer;" src="' + this.image + '/socialhome.png" ' +
          'alt="Socialhome" title="Socialhome" height="45" id="siseSocialhome" /> ' +
      '</p>'
  },
  ...
  image: 'https://notabug.org/sepbit/sise/raw/1.0.0/assets/images'
}
